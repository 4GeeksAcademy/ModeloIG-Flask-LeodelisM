...
Revision ID: 622cc59def27
Revises: a5cffa318ac2
Create Date: 2025-03-17 15:39:05.255374
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('usernamer', sa.String(), nullable=False))
        ...
        batch_op.create_unique_constraint(None, ['usernamer'])
